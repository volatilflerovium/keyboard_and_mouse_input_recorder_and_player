...
{
{"BACKSLASH_EXT", KEY_102ND}, // this is because a bug https://github.com/systemd/systemd/pull/9390
{"HASH_EXT", KEY_BACKSLASH}, // this is because of the same bug
	{"CTRL", KEY_LEFTCTRL}, // for practicality
	{"SHIFT", KEY_LEFTSHIFT}, //
	{"WIN", KEY_LEFTMETA},
	{"ALT", KEY_LEFTALT},
	{"LEFTARROW", KEY_LEFT},
...
static const std::map<std::string, int> shortcutParserKeyMap
{
	...
	{"BACKARROW", KEY_LEFT},
	{"DOWNARROW", KEY_DOWN},
	{"FORWARDARROW", KEY_RIGHT},
	{"CTRL", KEY_LEFTCTRL},
	{"R-CTRL", KEY_RIGHTCTRL},
	{"ALT", KEY_LEFTALT},
	{"R-ALT", KEY_RIGHTALT},
	{"SHIFT", KEY_LEFTSHIFT},
	{"R-SHIFT", KEY_RIGHTSHIFT},
	{"SUPER", KEY_LEFTMETA},
	{"-", KEY_MINUS},
	{"=", KEY_EQUAL},
	{"[", KEY_LEFTBRACE},
	...
	{"\\", KEY_102ND},
	{"`", KEY_GRAVE},
	{"#", KEY_BACKSLASH},// README: this is correct
	{"A", KEY_A},
	{"B", KEY_B},
	{"C", KEY_C},
	{"D", KEY_D},
